...
class QuestionView: UIView {
    ...
    var futura = UIFont(name: "Futura", size: CGFloat(28.0))
    ...
    init(frame: CGRect, question: String, answer: Bool, center: CGPoint) {
        ...
        questionField.backgroundColor = UIColor(red: 255/255.0, green: 255/255.0, blue: 255/255.0, alpha: 1.0)
        questionField.textAlignment = NSTextAlignment.center
        ///questionField.frame = CGRect(x:0, y:0, width:300, height: 350)
        questionField.frame = CGRect(x: -100, y: -100, width: 250, height: 280)
    ...
    func returnToCenter() {
        UIView.animate(withDuration: 0.8, delay: 0.1, usingSpringWithDamping: 0.8, initialSpringVelocity: 1.0, animations: {
